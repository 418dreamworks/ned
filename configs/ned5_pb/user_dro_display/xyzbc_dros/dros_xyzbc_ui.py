...
################################################################################
## Form generated from reading UI file 'dros_xyzbc.ui'
##
...
class Ui_dros_xyzbc(object):
    def setupUi(self, dros_xyzbc):
        if not dros_xyzbc.objectName():
            dros_xyzbc.setObjectName(u"dros_xyzbc")
        ...
        dros_xyzbc.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.verticalLayout = QVBoxLayout(dros_xyzbc)
        self.verticalLayout.setSpacing(4)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.widget_xyzbc = QWidget(dros_xyzbc)
        self.widget_xyzbc.setObjectName(u"widget_xyzbc")
        self.verticalLayout_4 = QVBoxLayout(self.widget_xyzbc)
...
"}")
        ...
        self.frame = QFrame(self.widget_xyzbc)
...
"}")
        ...
        QMetaObject.connectSlotsByName(dros_xyzbc)
    # setupUi

    def retranslateUi(self, dros_xyzbc):
        dros_xyzbc.setWindowTitle(QCoreApplication.translate("dros_xyzbc", u"dros_xyzbc", None))
        self.zero_all_button.setText(QCoreApplication.translate("dros_xyzbc", u"ALL", None))
        self.zero_all_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzbc", u"[\n"
"    {\n"
"        \"channels\": [\n"
"            {\n"
...
"    }\n"
"]", None))
        self.zero_all_button.setProperty(u"MDICommand", QCoreApplication.translate("dros_xyzbc", u"G10 L20 P{ch[0]} X0.0 Y0.0 Z0.0 B0.0 C0.0", None))
        self.work_column_header.setProperty(u"rules", QCoreApplication.translate("dros_xyzbc", u"[{\"channels\": [{\"url\": \"status:g5x_index?text\", \"trigger\": true}], \"property\": \"Text\", \"expression\": \"ch[0] + ' WORK'\\n\", \"name\": \"WCS Header\"}]", None))
        self.machine_column_header.setText(QCoreApplication.translate("dros_xyzbc", u"MACHINE", None))
        self.dtg_column_header.setText(QCoreApplication.translate("dros_xyzbc", u"DTG", None))
        self.ref_all_button.setText(QCoreApplication.translate("dros_xyzbc", u"REF ALL", None))
        self.ref_all_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzbc", u"[{\"channels\": [{\"url\": \"status:all_axes_homed\", \"trigger\": true}], \"property\": \"Text\", \"expression\": \"'HOMED' if ch[0] else 'REF ALL'\", \"name\": \"reference_all\"}, {\"name\": \"home_prohibit\", \"property\": \"Enable\", \"expression\": \"not (ch[0] or ch[1] or ch[2] or ch[3] or ch[4])\", \"channels\": [{\"url\": \"status:joint.0.homing\", \"trigger\": true}, {\"url\": \"status:joint.1.homing\", \"trigger\": true}, {\"url\": \"status:joint.2.homing\", \"trigger\": true}, {\"url\": \"status:joint.3.homing\", \"trigger\": true}, {\"url\": \"status:joint.4.homing\", \"trigger\": true}]}]", None))
        self.ref_all_button.setProperty(u"actionName", QCoreApplication.translate("dros_xyzbc", u"machine.home.all", None))
        self.zero_x_button.setText(QCoreApplication.translate("dros_xyzbc", u"X", None))
        self.zero_x_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzbc", u"[\n"
"    {\n"
"        \"channels\": [\n"
"            {\n"
"                \"url\": \"status:g5x_index\",\n"
...
"    }\n"
"]", None))
        self.zero_x_button.setProperty(u"MDICommand", QCoreApplication.translate("dros_xyzbc", u"G10 L20 P{ch[0]} X0.0", None))
        self.dro_entry_main_x.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzbc", u"%9.4f", None))
        self.dro_entry_main_x.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzbc", u"%10.3f", None))
        self.dro_entry_main_x.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzbc", u"%10.2f", None))
        self.dro_entry_main_x.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzbc", u"dataField17", None))
        self.drolabel_machine_x.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzbc", u"%9.4f", None))
        self.drolabel_machine_x.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzbc", u"%10.3f", None))
        self.drolabel_machine_x.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzbc", u"%10.2f", None))
        self.drolabel_machine_x.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzbc", u"dataField17", None))
        self.drolabel_dtg_x.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzbc", u"%9.4f", None))
        self.drolabel_dtg_x.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzbc", u"%10.3f", None))
        self.drolabel_dtg_x.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzbc", u"%10.2f", None))
        self.drolabel_dtg_x.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzbc", u"dataField17", None))
        self.ref_x_button.setText(QCoreApplication.translate("dros_xyzbc", u"REF X", None))
        self.ref_x_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzbc", u"[{\"name\": \"home_prohibit\", \"property\": \"Enable\", \"expression\": \"not (ch[0] or ch[1] or ch[2] or ch[3] or ch[4])\", \"channels\": [{\"url\": \"status:joint.0.homing\", \"trigger\": true}, {\"url\": \"status:joint.1.homing\", \"trigger\": true}, {\"url\": \"status:joint.2.homing\", \"trigger\": true}, {\"url\": \"status:joint.3.homing\", \"trigger\": true}, {\"url\": \"status:joint.4.homing\", \"trigger\": true}]}]", None))
        self.ref_x_button.setProperty(u"actionName", QCoreApplication.translate("dros_xyzbc", u"machine.home.axis:x", None))
        self.zero_y_button.setText(QCoreApplication.translate("dros_xyzbc", u"Y", None))
        self.zero_y_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzbc", u"[\n"
"    {\n"
"        \"channels\": [\n"
"            {\n"
"                \"url\": \"status:g5x_index\",\n"
...
"    }\n"
"]", None))
        self.zero_y_button.setProperty(u"MDICommand", QCoreApplication.translate("dros_xyzbc", u"G10 L20 P{ch[0]} Y0.0", None))
        self.dro_entry_main_y.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzbc", u"dataField17", None))
        self.drolabel_machine_y.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzbc", u"%9.4f", None))
        self.drolabel_machine_y.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzbc", u"%10.3f", None))
        self.drolabel_machine_y.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzbc", u"%10.2f", None))
        self.drolabel_machine_y.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzbc", u"dataField17", None))
        self.drolabel_dtg_y.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzbc", u"%9.4f", None))
        self.drolabel_dtg_y.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzbc", u"%10.3f", None))
        self.drolabel_dtg_y.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzbc", u"%10.2f", None))
        self.drolabel_dtg_y.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzbc", u"dataField17", None))
        self.ref_y_button.setText(QCoreApplication.translate("dros_xyzbc", u"REF Y", None))
        self.ref_y_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzbc", u"[{\"name\": \"home_prohibit\", \"property\": \"Enable\", \"expression\": \"not (ch[0] or ch[1] or ch[2] or ch[3] or ch[4])\", \"channels\": [{\"url\": \"status:joint.0.homing\", \"trigger\": true}, {\"url\": \"status:joint.1.homing\", \"trigger\": true}, {\"url\": \"status:joint.2.homing\", \"trigger\": true}, {\"url\": \"status:joint.3.homing\", \"trigger\": true}, {\"url\": \"status:joint.4.homing\", \"trigger\": true}]}]", None))
        self.ref_y_button.setProperty(u"actionName", QCoreApplication.translate("dros_xyzbc", u"machine.home.axis:y", None))
        self.zero_z_button.setText(QCoreApplication.translate("dros_xyzbc", u"Z", None))
        self.zero_z_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzbc", u"[\n"
"    {\n"
"        \"channels\": [\n"
"            {\n"
"                \"url\": \"status:g5x_index\",\n"
...
"    }\n"
"]", None))
        self.zero_z_button.setProperty(u"MDICommand", QCoreApplication.translate("dros_xyzbc", u"G10 L20 P{ch[0]} Z0.0", None))
        self.dro_entry_main_z.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzbc", u"dataField17", None))
        self.drolabel_machine_z.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzbc", u"%9.4f", None))
        self.drolabel_machine_z.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzbc", u"%10.3f", None))
        self.drolabel_machine_z.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzbc", u"%10.2f", None))
        self.drolabel_machine_z.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzbc", u"dataField17", None))
        self.drolabel_dtg_z.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzbc", u"%9.4f", None))
        self.drolabel_dtg_z.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzbc", u"%10.3f", None))
        self.drolabel_dtg_z.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzbc", u"%10.2f", None))
        self.drolabel_dtg_z.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzbc", u"dataField17", None))
        self.ref_z_button.setText(QCoreApplication.translate("dros_xyzbc", u"REF Z", None))
        self.ref_z_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzbc", u"[{\"name\": \"home_prohibit\", \"property\": \"Enable\", \"expression\": \"not (ch[0] or ch[1] or ch[2] or ch[3] or ch[4])\", \"channels\": [{\"url\": \"status:joint.0.homing\", \"trigger\": true}, {\"url\": \"status:joint.1.homing\", \"trigger\": true}, {\"url\": \"status:joint.2.homing\", \"trigger\": true}, {\"url\": \"status:joint.3.homing\", \"trigger\": true}, {\"url\": \"status:joint.4.homing\", \"trigger\": true}]}]", None))
        self.ref_z_button.setProperty(u"actionName", QCoreApplication.translate("dros_xyzbc", u"machine.home.axis:z", None))
        self.zero_b_button.setText(QCoreApplication.translate("dros_xyzbc", u"B", None))
        self.zero_b_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzbc", u"[\n"
"    {\n"
"        \"channels\": [\n"
"            {\n"
"                \"url\": \"status:g5x_index\",\n"
...
"    }\n"
"]", None))
        self.zero_b_button.setProperty(u"MDICommand", QCoreApplication.translate("dros_xyzbc", u"G10 L20 P{ch[0]} B0.0", None))
        self.dro_entry_main_b.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzbc", u"%9.4f", None))
        self.dro_entry_main_b.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzbc", u"%10.3f", None))
        self.dro_entry_main_b.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzbc", u"%10.2f", None))
        self.dro_entry_main_b.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzbc", u"dataField17", None))
        self.drolabel_machine_b.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzbc", u"%9.4f", None))
        self.drolabel_machine_b.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzbc", u"%10.3f", None))
        self.drolabel_machine_b.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzbc", u"%10.2f", None))
        self.drolabel_machine_b.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzbc", u"dataField17", None))
        self.drolabel_dtg_b.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzbc", u"%9.4f", None))
        self.drolabel_dtg_b.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzbc", u"%10.3f", None))
        self.drolabel_dtg_b.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzbc", u"%10.2f", None))
        self.drolabel_dtg_b.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzbc", u"dataField17", None))
        self.ref_b_button.setText(QCoreApplication.translate("dros_xyzbc", u"REF B", None))
        self.ref_b_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzbc", u"[{\"name\": \"home_prohibit\", \"property\": \"Enable\", \"expression\": \"not (ch[0] or ch[1] or ch[2] or ch[3] or ch[4])\", \"channels\": [{\"url\": \"status:joint.0.homing\", \"trigger\": true}, {\"url\": \"status:joint.1.homing\", \"trigger\": true}, {\"url\": \"status:joint.2.homing\", \"trigger\": true}, {\"url\": \"status:joint.3.homing\", \"trigger\": true}, {\"url\": \"status:joint.4.homing\", \"trigger\": true}]}]", None))
        self.ref_b_button.setProperty(u"actionName", QCoreApplication.translate("dros_xyzbc", u"machine.home.axis:b", None))
        self.zero_c_button.setText(QCoreApplication.translate("dros_xyzbc", u"C", None))
        self.zero_c_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzbc", u"[\n"
"    {\n"
"        \"channels\": [\n"
"            {\n"
"                \"url\": \"status:g5x_index\",\n"
...
"    }\n"
"]", None))
        self.zero_c_button.setProperty(u"MDICommand", QCoreApplication.translate("dros_xyzbc", u"G10 L20 P{ch[0]} C0.0", None))
        self.dro_entry_main_c.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzbc", u"%9.4f", None))
        self.dro_entry_main_c.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzbc", u"%10.3f", None))
        self.dro_entry_main_c.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzbc", u"%10.2f", None))
        self.dro_entry_main_c.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzbc", u"dataField17", None))
        self.drolabel_machine_c.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzbc", u"%9.4f", None))
        self.drolabel_machine_c.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzbc", u"%10.3f", None))
        self.drolabel_machine_c.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzbc", u"%10.2f", None))
        self.drolabel_machine_c.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzbc", u"dataField17", None))
        self.drolabel_dtg_c.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzbc", u"%9.4f", None))
        self.drolabel_dtg_c.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzbc", u"%10.3f", None))
        self.drolabel_dtg_c.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzbc", u"%10.2f", None))
        self.drolabel_dtg_c.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzbc", u"dataField17", None))
        self.ref_c_button.setText(QCoreApplication.translate("dros_xyzbc", u"REF C", None))
        self.ref_c_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzbc", u"[{\"name\": \"home_prohibit\", \"property\": \"Enable\", \"expression\": \"not (ch[0] or ch[1] or ch[2] or ch[3] or ch[4])\", \"channels\": [{\"url\": \"status:joint.0.homing\", \"trigger\": true}, {\"url\": \"status:joint.1.homing\", \"trigger\": true}, {\"url\": \"status:joint.2.homing\", \"trigger\": true}, {\"url\": \"status:joint.3.homing\", \"trigger\": true}, {\"url\": \"status:joint.4.homing\", \"trigger\": true}]}]", None))
        self.ref_c_button.setProperty(u"actionName", QCoreApplication.translate("dros_xyzbc", u"machine.home.axis:c", None))
    # retranslateUi
