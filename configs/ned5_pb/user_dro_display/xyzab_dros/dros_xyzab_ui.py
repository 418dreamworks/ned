...
################################################################################
## Form generated from reading UI file 'dros_xyzab.ui'
##
...
class Ui_dros_xyzab(object):
    def setupUi(self, dros_xyzab):
        if not dros_xyzab.objectName():
            dros_xyzab.setObjectName(u"dros_xyzab")
        ...
        dros_xyzab.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.verticalLayout = QVBoxLayout(dros_xyzab)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.widget_xyzab = QWidget(dros_xyzab)
        self.widget_xyzab.setObjectName(u"widget_xyzab")
        self.verticalLayout_4 = QVBoxLayout(self.widget_xyzab)
...
"}")
        ...
        self.frame = QFrame(self.widget_xyzab)
...
"}")
        ...
        QMetaObject.connectSlotsByName(dros_xyzab)
    # setupUi

    def retranslateUi(self, dros_xyzab):
        dros_xyzab.setWindowTitle(QCoreApplication.translate("dros_xyzab", u"dros_xyzab", None))
        self.zero_all_button.setText(QCoreApplication.translate("dros_xyzab", u"ALL", None))
        self.zero_all_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzab", u"[\n"
"    {\n"
"        \"channels\": [\n"
"            {\n"
...
"    }\n"
"]", None))
        self.zero_all_button.setProperty(u"MDICommand", QCoreApplication.translate("dros_xyzab", u"G10 L20 P{ch[0]} X0.0 Y0.0 Z0.0 A0.0 B0.0", None))
        self.work_column_header.setProperty(u"rules", QCoreApplication.translate("dros_xyzab", u"[{\"channels\": [{\"url\": \"status:g5x_index?text\", \"trigger\": true}], \"property\": \"Text\", \"expression\": \"ch[0] + ' WORK'\\n\", \"name\": \"WCS Header\"}]", None))
        self.machine_column_header.setText(QCoreApplication.translate("dros_xyzab", u"MACHINE", None))
        self.dtg_column_header.setText(QCoreApplication.translate("dros_xyzab", u"DTG", None))
        self.ref_all_button.setText(QCoreApplication.translate("dros_xyzab", u"REF ALL", None))
        self.ref_all_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzab", u"[{\"channels\": [{\"url\": \"status:all_axes_homed\", \"trigger\": true}], \"property\": \"Text\", \"expression\": \"'HOMED' if ch[0] else 'REF ALL'\", \"name\": \"reference_all\"}, {\"name\": \"home_prohibit\", \"property\": \"Enable\", \"expression\": \"not (ch[0] or ch[1] or ch[2] or ch[3] or ch[4])\", \"channels\": [{\"url\": \"status:joint.0.homing\", \"trigger\": true}, {\"url\": \"status:joint.1.homing\", \"trigger\": true}, {\"url\": \"status:joint.2.homing\", \"trigger\": true}, {\"url\": \"status:joint.3.homing\", \"trigger\": true}, {\"url\": \"status:joint.4.homing\", \"trigger\": true}]}]", None))
        self.ref_all_button.setProperty(u"actionName", QCoreApplication.translate("dros_xyzab", u"machine.home.all", None))
        self.zero_x_button.setText(QCoreApplication.translate("dros_xyzab", u"X", None))
        self.zero_x_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzab", u"[\n"
"    {\n"
"        \"channels\": [\n"
"            {\n"
"                \"url\": \"status:g5x_index\",\n"
...
"    }\n"
"]", None))
        self.zero_x_button.setProperty(u"MDICommand", QCoreApplication.translate("dros_xyzab", u"G10 L20 P{ch[0]} X0.0", None))
        self.dro_entry_main_x.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzab", u"%9.4f", None))
        self.dro_entry_main_x.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzab", u"%10.3f", None))
        self.dro_entry_main_x.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzab", u"%10.2f", None))
        self.dro_entry_main_x.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzab", u"dataField17", None))
        self.drolabel_machine_x.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzab", u"%9.4f", None))
        self.drolabel_machine_x.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzab", u"%10.3f", None))
        self.drolabel_machine_x.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzab", u"%10.2f", None))
        self.drolabel_machine_x.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzab", u"dataField17", None))
        self.drolabel_dtg_x.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzab", u"%9.4f", None))
        self.drolabel_dtg_x.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzab", u"%10.3f", None))
        self.drolabel_dtg_x.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzab", u"%10.2f", None))
        self.drolabel_dtg_x.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzab", u"dataField17", None))
        self.ref_x_button.setText(QCoreApplication.translate("dros_xyzab", u"REF X", None))
        self.ref_x_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzab", u"[{\"name\": \"home_prohibit\", \"property\": \"Enable\", \"expression\": \"not (ch[0] or ch[1] or ch[2] or ch[3] or ch[4])\", \"channels\": [{\"url\": \"status:joint.0.homing\", \"trigger\": true}, {\"url\": \"status:joint.1.homing\", \"trigger\": true}, {\"url\": \"status:joint.2.homing\", \"trigger\": true}, {\"url\": \"status:joint.3.homing\", \"trigger\": true}, {\"url\": \"status:joint.4.homing\", \"trigger\": true}]}]", None))
        self.ref_x_button.setProperty(u"actionName", QCoreApplication.translate("dros_xyzab", u"machine.home.axis:x", None))
        self.zero_y_button.setText(QCoreApplication.translate("dros_xyzab", u"Y", None))
        self.zero_y_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzab", u"[\n"
"    {\n"
"        \"channels\": [\n"
"            {\n"
"                \"url\": \"status:g5x_index\",\n"
...
"    }\n"
"]", None))
        self.zero_y_button.setProperty(u"MDICommand", QCoreApplication.translate("dros_xyzab", u"G10 L20 P{ch[0]} Y0.0", None))
        self.dro_entry_main_y.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzab", u"dataField17", None))
        self.drolabel_machine_y.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzab", u"%9.4f", None))
        self.drolabel_machine_y.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzab", u"%10.3f", None))
        self.drolabel_machine_y.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzab", u"%10.2f", None))
        self.drolabel_machine_y.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzab", u"dataField17", None))
        self.drolabel_dtg_y.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzab", u"%9.4f", None))
        self.drolabel_dtg_y.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzab", u"%10.3f", None))
        self.drolabel_dtg_y.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzab", u"%10.2f", None))
        self.drolabel_dtg_y.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzab", u"dataField17", None))
        self.ref_y_button.setText(QCoreApplication.translate("dros_xyzab", u"REF Y", None))
        self.ref_y_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzab", u"[{\"name\": \"home_prohibit\", \"property\": \"Enable\", \"expression\": \"not (ch[0] or ch[1] or ch[2] or ch[3] or ch[4])\", \"channels\": [{\"url\": \"status:joint.0.homing\", \"trigger\": true}, {\"url\": \"status:joint.1.homing\", \"trigger\": true}, {\"url\": \"status:joint.2.homing\", \"trigger\": true}, {\"url\": \"status:joint.3.homing\", \"trigger\": true}, {\"url\": \"status:joint.4.homing\", \"trigger\": true}]}]", None))
        self.ref_y_button.setProperty(u"actionName", QCoreApplication.translate("dros_xyzab", u"machine.home.axis:y", None))
        self.zero_z_button.setText(QCoreApplication.translate("dros_xyzab", u"Z", None))
        self.zero_z_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzab", u"[\n"
"    {\n"
"        \"channels\": [\n"
"            {\n"
"                \"url\": \"status:g5x_index\",\n"
...
"    }\n"
"]", None))
        self.zero_z_button.setProperty(u"MDICommand", QCoreApplication.translate("dros_xyzab", u"G10 L20 P{ch[0]} Z0.0", None))
        self.dro_entry_main_z.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzab", u"dataField17", None))
        self.drolabel_machine_z.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzab", u"%9.4f", None))
        self.drolabel_machine_z.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzab", u"%10.3f", None))
        self.drolabel_machine_z.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzab", u"%10.2f", None))
        self.drolabel_machine_z.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzab", u"dataField17", None))
        self.drolabel_dtg_z.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzab", u"%9.4f", None))
        self.drolabel_dtg_z.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzab", u"%10.3f", None))
        self.drolabel_dtg_z.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzab", u"%10.2f", None))
        self.drolabel_dtg_z.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzab", u"dataField17", None))
        self.ref_z_button.setText(QCoreApplication.translate("dros_xyzab", u"REF Z", None))
        self.ref_z_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzab", u"[{\"name\": \"home_prohibit\", \"property\": \"Enable\", \"expression\": \"not (ch[0] or ch[1] or ch[2] or ch[3] or ch[4])\", \"channels\": [{\"url\": \"status:joint.0.homing\", \"trigger\": true}, {\"url\": \"status:joint.1.homing\", \"trigger\": true}, {\"url\": \"status:joint.2.homing\", \"trigger\": true}, {\"url\": \"status:joint.3.homing\", \"trigger\": true}, {\"url\": \"status:joint.4.homing\", \"trigger\": true}]}]", None))
        self.ref_z_button.setProperty(u"actionName", QCoreApplication.translate("dros_xyzab", u"machine.home.axis:z", None))
        self.zero_a_button.setText(QCoreApplication.translate("dros_xyzab", u"A", None))
        self.zero_a_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzab", u"[\n"
"    {\n"
"        \"channels\": [\n"
"            {\n"
"                \"url\": \"status:g5x_index\",\n"
...
"    }\n"
"]", None))
        self.zero_a_button.setProperty(u"MDICommand", QCoreApplication.translate("dros_xyzab", u"G10 L20 P{ch[0]} A0.0", None))
        self.dro_entry_main_a.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzab", u"dataField17", None))
        self.drolabel_machine_a.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzab", u"%9.4f", None))
        self.drolabel_machine_a.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzab", u"%10.3f", None))
        self.drolabel_machine_a.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzab", u"%10.2f", None))
        self.drolabel_machine_a.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzab", u"dataField17", None))
        self.drolabel_dtg_a.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzab", u"%9.4f", None))
        self.drolabel_dtg_a.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzab", u"%10.3f", None))
        self.drolabel_dtg_a.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzab", u"%10.2f", None))
        self.drolabel_dtg_a.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzab", u"dataField17", None))
        self.ref_a_button.setText(QCoreApplication.translate("dros_xyzab", u"REF A", None))
        self.ref_a_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzab", u"[{\"name\": \"home_prohibit\", \"property\": \"Enable\", \"expression\": \"not (ch[0] or ch[1] or ch[2] or ch[3] or ch[4])\", \"channels\": [{\"url\": \"status:joint.0.homing\", \"trigger\": true}, {\"url\": \"status:joint.1.homing\", \"trigger\": true}, {\"url\": \"status:joint.2.homing\", \"trigger\": true}, {\"url\": \"status:joint.3.homing\", \"trigger\": true}, {\"url\": \"status:joint.4.homing\", \"trigger\": true}]}]", None))
        self.ref_a_button.setProperty(u"actionName", QCoreApplication.translate("dros_xyzab", u"machine.home.axis:a", None))
        self.zero_b_button.setText(QCoreApplication.translate("dros_xyzab", u"B", None))
        self.zero_b_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzab", u"[\n"
"    {\n"
"        \"channels\": [\n"
"            {\n"
"                \"url\": \"status:g5x_index\",\n"
...
"    }\n"
"]", None))
        self.zero_b_button.setProperty(u"MDICommand", QCoreApplication.translate("dros_xyzab", u"G10 L20 P{ch[0]} B0.0", None))
        self.dro_entry_main_b.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzab", u"%9.4f", None))
        self.dro_entry_main_b.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzab", u"%10.3f", None))
        self.dro_entry_main_b.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzab", u"%10.2f", None))
        self.dro_entry_main_b.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzab", u"dataField17", None))
        self.drolabel_machine_b.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzab", u"%9.4f", None))
        self.drolabel_machine_b.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzab", u"%10.3f", None))
        self.drolabel_machine_b.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzab", u"%10.2f", None))
        self.drolabel_machine_b.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzab", u"dataField17", None))
        self.drolabel_dtg_b.setProperty(u"inchFormat", QCoreApplication.translate("dros_xyzab", u"%9.4f", None))
        self.drolabel_dtg_b.setProperty(u"millimeterFormat", QCoreApplication.translate("dros_xyzab", u"%10.3f", None))
        self.drolabel_dtg_b.setProperty(u"degreeFormat", QCoreApplication.translate("dros_xyzab", u"%10.2f", None))
        self.drolabel_dtg_b.setProperty(u"styleSet", QCoreApplication.translate("dros_xyzab", u"dataField17", None))
        self.ref_b_button.setText(QCoreApplication.translate("dros_xyzab", u"REF B", None))
        self.ref_b_button.setProperty(u"rules", QCoreApplication.translate("dros_xyzab", u"[{\"name\": \"home_prohibit\", \"property\": \"Enable\", \"expression\": \"not (ch[0] or ch[1] or ch[2] or ch[3] or ch[4])\", \"channels\": [{\"url\": \"status:joint.0.homing\", \"trigger\": true}, {\"url\": \"status:joint.1.homing\", \"trigger\": true}, {\"url\": \"status:joint.2.homing\", \"trigger\": true}, {\"url\": \"status:joint.3.homing\", \"trigger\": true}, {\"url\": \"status:joint.4.homing\", \"trigger\": true}]}]", None))
        self.ref_b_button.setProperty(u"actionName", QCoreApplication.translate("dros_xyzab", u"machine.home.axis:b", None))
    # retranslateUi
