...
################################################################################
## Form generated from reading UI file 'offset_dros_xyzab.ui'
##
...
"]", None))
        ...
        self.g52_g92_y.setProperty(u"rules", QCoreApplication.translate("offset_dros_xyzab", u"[{\"channels\": [{\"trigger\": true, \"type\": \"tuple\", \"url\": \"status:tool_offset\"}], \"property\": \"Text\", \"expression\": \"\\\"{:.4f}\\\".format(ch[0][1])\", \"name\": \"New Rule\"}]", None))
        self.g52_g92_y.setProperty(u"styleSet", QCoreApplication.translate("offset_dros_xyzab", u"dataField17", None))
        self.tool_offset_y.setProperty(u"rules", QCoreApplication.translate("offset_dros_xyzab", u"[{\"channels\": [{\"trigger\": true, \"type\": \"tuple\", \"url\": \"status:g92_offset\"}], \"property\": \"Text\", \"expression\": \"\\\"{:.4f}\\\".format(ch[0][1])\", \"name\": \"New Rule\"}]", None))
