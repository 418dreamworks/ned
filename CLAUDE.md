...
10. Documents state the FINAL, current fact ONLY — NO origin stories. Never write history in a doc ("originally", "we tried X then Y", "turned out", "used to be", "previously hypothesized", dated diagnostic narrative, superseded-plan context). How-we-got-here does not belong in the doc — just what IS.
