<!-- Mirror of https://linuxcnc.org/docs/html/hal/halshow.html -->
...
For more information regarding the format, please refer to [the Tcl format man page](https://www.tcl.tk/man/tcl/TclCmd/format.html).



    Figure 1. Halshow Layout
...
-
 ...
 Remove a pin from the list
    ...
    Figure 4. Halshow: Watch Tab Context Menu
