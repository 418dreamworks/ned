<!-- Mirror of https://linuxcnc.org/docs/html/hal/parallel-port.html -->
...
More information on DoubleStep can be found on the [wiki](https://wiki.linuxcnc.org/cgi-bin/wiki.pl?TweakingSoftwareStepGeneration).
